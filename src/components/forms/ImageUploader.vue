<template>
  <div class="space-y-2">
    ...
    <div
      ...
      :class="[
        dragOver ? 'border-primary bg-primary/5' : 'border-border hover:border-primary/50 hover:bg-surface',
    ...
    >
      ...
      <div v-else class="space-y-2 text-slate-400">
        ...
        <p class="text-sm font-medium">Cliquez ou deposez une image ici</p>
    ...
    <div v-if="cloudinaryMissing && previewUrl" class="flex items-center gap-2 text-xs text-amber-600 bg-amber-50 border border-amber-200 rounded-lg px-3 py-2">
      ...
      Image sauvegardee localement. Configurez Cloudinary dans .env pour l'hebergement cloud.
    </div>
